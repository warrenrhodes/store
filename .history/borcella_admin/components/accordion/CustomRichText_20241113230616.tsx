...
// Type for the Jodit instance
interface IjoditInstance extends IJodit {
  selection: {
    insertHTML: (html: string) => void;
  };
}

// Type for the editor reference
interface IJoditEditorRef {
  current: {
    instance: IjoditInstance;
  } | null;
}
const CustomRichTextEditor = ({
  ...
  const editor: RefObject<IJoditEditorRef> = useRef(null);
  ...
  const handleMediaInsert = () => {
    if (mediaUrl) {
      ...
      editor.current.current?.instance.selection.insertHTML(mediaTag);
      setMediaUrl("");
