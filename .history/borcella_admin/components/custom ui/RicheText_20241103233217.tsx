  ...
  return (
    <div className="border-b p-2 mb-2 flex gap-2 flex-wrap">
      ...
      <Button
        size="sm"
        variant={
          editor.isActive({ textAlign: "center" }) ? "outline" : "default"
        }
      ...
      <Button
        size="sm"
        variant={
          editor.isActive({ textAlign: "right" }) ? "outline" : "default"
        }
      ...
      <Button
        size="sm"
        variant={
          editor.isActive({ textAlign: "justify" }) ? "outline" : "default"
        }
      ...
      <CardContent className="p-4">
        ...
        <div className="flex justify-end gap-2 mb-2">
          ...
          <Button
            ...
            size="sm"
            onClick={onDelete}
            className=" hover:bg-red-500/15 text-red-500"
          >
            <Trash2 size={20} />
          </Button>
          <Button
            ...
            className=" hover:bg-green-500/15 text-green-500"
          >
            <CheckCircle size={20} />
          </Button>
        </div>
