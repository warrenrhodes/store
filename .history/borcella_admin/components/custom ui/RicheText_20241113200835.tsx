  ...
  return (
    <div class="font-[sans-serif] border divide-y rounded-lg">
      ...
      <div role="accordion">
        <button
          type="button"
          class="w-full text-base text-left font-semibold p-5 text-gray-800 hover:text-blue-600 flex items-center transition-all"
        >
          <span class="mr-4">
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-4 fill-current ml-auto shrink-0 -rotate-90"
            viewBox="0 0 24 24"
          >
            <path
              fill-rule="evenodd"
