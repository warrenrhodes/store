...
const ProductDescriptionBuilder: React.FC<ProductDescriptionBuilderProps> = ({
  ...
  const [isContentCollapse, setIsContentCollapse] = useState<boolean>(false);
  ...
  return (
    <div className="flex-col">
      <Accordion
        type="single"
        collapsible={isContentCollapse}
        onValueChange={(value) => setIsContentCollapse(!isContentCollapse)}
      >
  ...
  return (
    <div className="font-[sans-serif] border divide-y rounded-lg">
      <div role="accordion">
        <button
          type="button"
          className="w-full text-base text-left font-semibold p-5 text-blue-600 border-b flex items-center transition-all"
        >
          <span className="mr-4">Checking for quick fixes... event.</span>
          <svg
      ...
      <div role="accordion">
        <button
          type="button"
          className="w-full text-base text-left font-semibold p-5 text-gray-800 hover:text-blue-600 flex items-center transition-all"
        >
          <span className="mr-4">
