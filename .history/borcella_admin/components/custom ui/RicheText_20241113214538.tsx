...
import CustomAccordionItem, { ContentElement } from "../accordion/CustomAccordionItem";

type AccordionType = "text" | "image" | "video";
          ...
          {elements.length > 0 &&
            elements.map((element, index) => (
              <CustomAccordionItem
                ...
                index={index}
                key={element.id}
                onChange={function (value: StoredProductDescription): void {
                  throw new Error("Function not implemented.");
                }}
                listContentType={["image", "text", "video"]}
                isLast={false}
                onDelete={() => {}}
                onMoveDown={() => {}}
                onMoveUp={() => {}}
