...
const ProductCTA = ({
  ...
  return (
    <div className="relative w-full min-h-[500px] p-4">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#6626d9] via-[#a91079] to-[#e91e63]">
        {/* Overlay pattern for added depth */}
      ...
      <div
        ...
        } backdrop-blur-md rounded-xl shadow-2xl transition-colors duration-300 border border-white/10`}
      >
        {/* Desktop Layout */}
