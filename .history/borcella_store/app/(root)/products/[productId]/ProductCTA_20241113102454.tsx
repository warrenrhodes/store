        ...
        <div className="hidden md:grid md:grid-cols-2 gap-8 p-5">
          ...
          <div className="space-y-4">
            <motion.button
              ...
              className="w-full py-4 px-6 bg-primary text-primary rounded-lg font-medium flex items-center justify-center gap-3 hover:shadow-lg transition-all duration-300 text-lg"
              onClick={() => {
                if (!cartItem) {
                  cart.addItem({
                    item: product,
