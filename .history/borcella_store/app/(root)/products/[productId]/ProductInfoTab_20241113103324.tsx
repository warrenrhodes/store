        ...
        <ul className="flex gap-4 bg-gray-100 rounded-2xl p-1 w-max overflow-hidden">
          {tabs.map((tab) => (
            <li
              ...
              className="tab text-white rounded-2xl font-bold text-center text-sm bg-blue-600 py-3 px-6 tracking-wide cursor-pointer"
            >
              {tab}
            </li>
          ))}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {review.helpful && (
                  <span>{review.helpful + (interaction.helpful ? 1 : 0)}</span>
                )}
              </button>
              <button
              ...
              >
                ...
                {review.notHelpful && (
                  <span>
                    {review.notHelpful + (interaction.notHelpful ? 1 : 0)}
                  </span>
                )}
              </button>
            </div>
