...
import { Plus, Minus, ShoppingCart, Star, StarHalf, CheckSquare } from "lucide-react";
...
const Benefices = asyncasync ({productId}:{productId:string}) => {
    ...
    <div>
      {benefices?.length > 0 && (
        benefices?.map((benefice) => (
          <div className="w-full bg-primary/10 rounder-lg h-30">
