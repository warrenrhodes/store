    ...
    <div>
      {benefices?.length > 0 &&
        benefices?.map((benefice) => (
          <div className="w-full bg-primary/10 rounder-lg h-30 p-2 mb-2">
    ...
    <div>
      {promotions.length > 0 && (
        <div>
          ...
          <div>
            {promotions.map((benefice) => (
              <div
                className={cn(
                  {
                    "border border-primary/50": current?.id === benefice.id,
                  },
                  "w-full bg-primary/10 rounder-lg p-3"
                )}
              >
                <div className="flex items-center">
                  <CheckSquare size={16} className="text-primary/50" />
