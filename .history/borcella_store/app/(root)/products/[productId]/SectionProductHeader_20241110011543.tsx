...
const Reviews = ({ reviews }: { reviews: ReviewType[] }) => {
  ...
  return (
    <div
      id="default-carousel"
      className="relative w-full max-w-4xl mx-auto bg-primary/15 rounded-xl shadow-lg overflow-hidden mt-4"
      data-carousel="slide"
    >
      <div className="relative h-32 md:h-36 overflow-hidden rounded-lg">
