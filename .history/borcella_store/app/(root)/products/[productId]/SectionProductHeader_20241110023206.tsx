    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <div className="relative">
        ...
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 -ml-12 p-2 rounded-full bg-white shadow-lg hover:bg-gray-100 transition-colors"
        >
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 -mr-12 p-2 rounded-full bg-white shadow-lg hover:bg-gray-100 transition-colors"
        >
        ...
        >
          <img
            ...
            alt={`${currentReview.userName}'s profile`}
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 text-gray-600">{currentReview.rating}</p>
          </div>
        </div>
    ...
    >
      <div className="relative h-32 md:h-36  rounded-lg">
        {reviews.map((review, index) => (
          <div className="hidden relative w-full h-full duration-700 ease-in-out data-carousel-item">
