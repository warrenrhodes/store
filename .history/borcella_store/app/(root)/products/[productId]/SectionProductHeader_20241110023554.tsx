    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <div className="relative">
        ...
        <button
          ...
          className="absolute left-2 top-1/2 -translate-y-1/2 -ml-12 p-2 rounded-full bg-white shadow-lg hover:bg-gray-100 transition-colors"
        >
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 -mr-12 p-2 rounded-full bg-white shadow-lg hover:bg-gray-100 transition-colors"
        >
