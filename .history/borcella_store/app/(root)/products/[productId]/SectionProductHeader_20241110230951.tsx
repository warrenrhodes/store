...
const Reviews = ({ reviews }: { reviews: ReviewType[] }) => {
  ...
  return (
    <div
      className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg mt-3"
      key={currentIndex}
    >
      <div className="relative">
        <button
...
// const ShipmentDetails = ({ shipment_details }: { shipment_details: any }) => {
//   return (
//     <div className="mt-4">
//       {shipment_details?.length > 0 &&
//         shipment_details?.map((shipment_detail) => (
//           <div
//             className="w-full bg-primary/10 rounded-lg h-30 p-1 mb-2"
//             key={shipment_detail._id}
//           >
              ...
              >
                <div className="flex items-center gap-2">
                  {current?._id === promo._id ? (
                    <CheckSquare size={16} className="text-primary font-bold" />
                  ) : (
                    <Square size={16} className="text-primary/50 font-bold" />
                  )}
                  <div className=" flex-1">
