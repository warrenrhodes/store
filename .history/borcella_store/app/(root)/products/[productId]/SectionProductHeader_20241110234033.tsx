...
const ShipmentDetails = ({
  ...
  return (
    <div className="mt-4 bg-primary/10 rounded-lg h-30 p-5 flex items-center overflow-hidden">
      {shipment_details?.length > 0 &&
        shipment_details.slice(0, 3).map((shipment_detail) => (
          <div className="flex-1 p-3" key={shipment_detail.description}>
            <div className="flex flex-col gap-4 justify-items-center">
              <p className="text-primary text-6xl self-center">
                {shipment_detail.icon}
              </p>
              <div
                className="prose prose-slate prose-sm sm:prose self-center"
