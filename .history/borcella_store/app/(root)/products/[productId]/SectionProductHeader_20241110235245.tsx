...
const ShipmentDetails = ({
  ...
  return (
    <div className="mt-4 bg-primary/10 rounded-lg h-30 p-3 flex items-center overflow-hidden">
      {shipment_details?.length > 0 &&
        shipment_details.slice(0, 3).map((shipment_detail) => (
          ...
          >
            <p className="text-primary text-6xl mb-4">{shipment_detail.icon}</p>
            <div
              className="prose prose-slate prose-sm sm:prose text-center text-sm"
