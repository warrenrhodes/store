...
const Reviews = ({ reviews }: { reviews: ReviewType[] }) => {
  ...
  return (
    <div
      className="max-w-2xl mx-auto p-6 bg-primary/5 rounded-lg shadow-xl mt-3"
      key={currentIndex}
    >
      <div className="relative">
        <button
          ...
          className="absolute left-3 top-1/2 -translate-y-1/2 -ml-12 p-2 rounded-full bg-white shadow-xl hover:bg-gray-100 transition-colors"
        >
        ...
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 -mr-12 p-2 rounded-full bg-white shadow-xl hover:bg-gray-100 transition-colors"
        >
...
const ShipmentDetails = ({
  ...
  return (
    <div className="mt-4 bg-primary/5 rounded-lg h-30 p-3 flex items-center overflow-hidden shadow-xl">
    ...
    <div className=" flex flex-col mt-4  gap-2">
      {benefices?.length > 0 &&
        benefices?.map((benefice) => (
          <div
            className="w-full rounded-lg h-30 p-1 bg-primary/5 shadow-xl"
            key={benefice.title}
          >
            ...
            {verifyPromos.map((promo) => (
              <div
                ...
                className={cn(
                  ...
                  "w-full bg-primary/5 rounded-lg p-3 mb-2 shadow-sm cursor-pointer shadow-xl"
                )}
