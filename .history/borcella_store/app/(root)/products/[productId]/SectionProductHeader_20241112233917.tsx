    ...
    <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-6 max-lg:gap-12">
      ...
      <div>
        ...
        <div className="mt-5 flex items-center gap-5">
          <motion.button  className="w-full py-3 px-4 bg-gradient-to-r from-[#6626d9] to-[#a91079] text-white rounded-lg font-medium flex items-center justify-center gap-2 hover:shadow-lg transition-all duration-300"Buy Now</motion.button>
          <motion.button
            //variant="outline"
...
const ShipmentDetails = ({
  ...
  return (
    <MotionDiv>
      <div className="mt-4 bg-primary/5 rounded-lg h-30 p-3 flex items-center overflow-hidden shadow-lg">
        {shipment_details?.length > 0 &&
          shipment_details.slice(0, 3).map((shipment_detail) => (
            ...
            >
              <span
                className={`text-3xl bg-gradient-to-r from-primary to-pink-600 bg-clip-text text-transparent`}
              >
      ...
      {benefices?.length > 0 &&
        benefices?.map((benefice, index) => (
          <MotionDiv key={benefice.title} index={index}>
            <div
              className="w-full rounded-lg h-30 p-3 bg-primary/5 shadow-lg"
              key={benefice.title}
            >
              ...
              <MotionDiv key={promo._id} index={index}>
                <div
                  className={cn(
                    ...
                    "w-full bg-primary/5 rounded-lg p-3 mb-2 cursor-pointer shadow-lg"
                  )}
