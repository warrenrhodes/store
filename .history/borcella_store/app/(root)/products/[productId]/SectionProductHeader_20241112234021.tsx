    ...
    <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-6 max-lg:gap-12">
      ...
      <div>
        ...
        <div className="mt-5 flex items-center gap-5">
          <motion.button className="w-full py-3 px-4 bg-gradient-to-r from-primary to-[#a91079] text-white rounded-lg font-medium flex items-center justify-center gap-2 hover:shadow-lg transition-all duration-300">
            Buy Now
          </motion.button>
          <motion.button
            //variant="outline"
