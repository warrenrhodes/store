    ...
    <div className="w-full">
      ...
      <div className="relative w-full max-w-4xl mx-auto h-screen flex items-center justify-center p-4">
        <div className="relative w-full h-full max-h-[600px]">
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 flex items-center justify-center">
          ...
          {product.benefices.map((benefit, index) => (
            ...
            >
              <div className="relative bg-primary/5 p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow">
