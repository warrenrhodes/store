...
const CurvedArrow = ({ direction }: { direction: string }) => {
  const getPath = () => {
    switch (direction) {
      ...
      case "bottomLeft":
        return `M398.929,111.802c-0.007-0.005-0.01-0.008-0.014-0.014c-0.604-0.599-1.233-1.17-1.889-1.706c-0.323-0.264-0.664-0.49-0.994-0.735c-0.326-0.24-0.641-0.494-0.977-0.719c-0.482-0.321-0.981-0.604-1.479-0.889c-0.211-0.122-0.416-0.257-0.631-0.372c-0.475-0.255-0.967-0.475-1.459-0.698c-0.26-0.118-0.516-0.254-0.779-0.364
