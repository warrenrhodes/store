  ...
  const benefits = [
    {
      ...
      arrowTransform: "rotate(65deg) scale(1.5)",
    },
    {
      position: "top-0 right-0",
      arrowTransform: "rotate(166deg) scale(1.5)",
    },
    {
      position: "bottom-0 left-0",
      arrowTransform: "rotate(351deg) scale(1.5)",
    },
    {
      position: "bottom-0 right-0",
      arrowTransform: "rotate(266deg) scale(1.5)",
    },
  ];
    ...
    <div className="w-full">
      ...
      <div className="relative w-full max-w-4xl mx-auto flex items-center justify-center p-4">
        <div className="relative w-full h-full max-h-[600px]">
          <div className="absolute left-1/2 top-1 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center overflow-hidden">
          ...
          {product.benefices.splice(0, 4).map((benefit, index) => (
            <div
              key={index}
              ...
              <div className="relative p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="relative w-full h-full">
                  <div
                    className={cn(
                      {
                        "top-1 left-36": index === 0,
                        "-top-20 -left-28": index === 1,
                        "bottom-48 -right-14": index === 2,
                        "-top-80 -right-72": index === 3,
                      },
                      "absolute"
                    )}
                  >
