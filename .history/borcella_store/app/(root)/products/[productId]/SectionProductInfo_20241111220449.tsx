...
const ProductInfoDetail = ({ product }: { product: ProductType }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 px-4 py-12 md:py-20">
      ...
      >
        <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold text-center uppercase tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
          The advantages of {product.title}
        </h3>
        <div className="w-32 md:w-48 h-1.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full" />
      </Motion>
      ...
      <div className="relative w-full max-w-6xl mx-auto">
        ...
        >
          <div className="relative w-full h-[250px] md:h-[400px] flex items-center justify-center">
            <div className="relative w-[80%] md:w-[500px] h-[200px] md:h-[300px] rounded-xl overflow-hidden group">
              ...
              <img
                ...
                alt={product.title}
                className={`object-cover w-full h-full rounded-xl shadow-2xl transform transition-all duration-700 ${
          ...
          <div className="hidden md:block relative w-full h-[600px]">
            {product.benefices.slice(0, 4).map((benefit, index) => (
              <Motion
                ...
                className={`absolute ${desktopPositions[index]} max-w-sm`}
              >
                <Card
                    ...
                    <div className="flex gap-4 items-start mb-3">
                      <span
                        className={`text-3xl bg-gradient-to-r ${
                          colors[Object.keys(colors)[index % 3]]
                        } bg-clip-text text-transparent`}
                      >
                        {benefit.icon}
                      </span>
                      <div
                        className="prose prose-slate font-bold text-lg"
