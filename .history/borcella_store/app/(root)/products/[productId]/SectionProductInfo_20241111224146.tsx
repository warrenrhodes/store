...
const ProductInfoDetail = ({ product }: { product: ProductType }) => {
  ...
  const desktopPositions = [
    "top-32 left-0 z-10", // Adjusted top spacing
    "top-32 right-0 z-10", // Adjusted top spacing
    "bottom-32 left-0 z-10", // Adjusted bottom spacing
    "bottom-32 right-0 z-10", // Adjusted bottom spacing
  ];
  ...
  return (
    <div className="w-full min-h-[80vh] px-4 py-12 md:py-20">
      ...
      >
        <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center uppercase tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-indigo-600">
        ...
        <motion.div
          ...
          className="h-1.5 bg-gradient-to-r from-primary to-indigo-600 rounded-full"
        />
      </motion.div>

      <div className="relative w-full max-w-7xl mx-auto">
        {/* Desktop Layout */}
        <div className="hidden md:block relative w-full h-[700px] mb-8 overflow-hidden">
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
            ...
            >
              <div className="relative w-[400px] h-[300px] group">
                ...
                />
                {/* Optional decorative elements for the image */}
                <div className="absolute -inset-0.5 bg-gradient-to-r from-violet-600/20 to-indigo-600/20 rounded-lg blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
            </motion.div>
          </div>
        ...
        <div className="md:hidden space-y-6">
          ...
          >
            <div className="relative w-full h-full group">
              <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-indigo-600/20 rounded-lg group-hover:opacity-0 transition-opacity duration-300" />
              <img
                src={`${process.env.NEXT_PUBLIC_SERVER_URL}${product.media[0].url}`}
                alt={product.title}
