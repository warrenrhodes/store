          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
            ...
            >
              <div className="relative w-[400px] h-[300px] group">
                ...
                />
                <div className="absolute -inset-0.5 bg-gradient-to-r from-primary/20 to-indigo-600/20 rounded-lg blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
            </motion.div>
          </div>
