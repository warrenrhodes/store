    ...
    <div className="flex items-center justify-center">
      <div className="relative group">
        <MotionDiv className="flex-1">
          <Button className="flex w-full  py-6 items-center gap-1 border-2 border-primary font-bold transition-all duration-300 hover:shadow-lg">
            Add to cart <ChevronRight size={20} />
          </Button>
        </MotionDiv>
        <button className="w-[300px] relative inline-block p-px font-semibold leading-6 text-white bg-white-800 shadow-2xl cursor-pointer rounded-lg shadow-zinc-900 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95">
          <span className="absolute inset-0 rounded-lg bg-gradient-to-r from-teal-400 via-red-500 to-purple-500 p-[2px] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>

          <span className="relative z-10 block px-6 py-3 rounded-lg bg-primary">
