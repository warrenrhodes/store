...
const shipment_details: {
  ...
  {
    icon: <Percent className="text-xl text-black" />,
    title: "Discount",
    description: "> $100 Disc 10%",
  },
  {
    icon: <Calendar className="text-xl text-black" />,
    title: "Delivery Time",
    description: "......",
  },
  {
    icon: <Package className="text-xl text-black" />,
    title: "Package",
    description: "Reagular Premium Box",
  },
  {
    icon: <Truck className="text-xl text-black" />,
