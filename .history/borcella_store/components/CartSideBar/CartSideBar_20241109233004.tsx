...
const CartSideBar: React.FC<CartSideBarProps> = () => {
  ...
  const calculateTotalPrice = (
    ...
    const promotionApplications = Math.floor(
      quantity / selectedPromotion.minProducts
    );
    const remainingItems = quantity % selectedPromotion.minProducts;

    const promotionTotal = promotionApplications * product.price;
