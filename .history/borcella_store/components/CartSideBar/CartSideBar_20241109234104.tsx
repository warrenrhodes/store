...
const CartSideBar: React.FC<CartSideBarProps> = () => {
  ...
  const calculateTotalPrice = (
    ...
    const promotionSets = Math.floor(quantity / promotion.minProducts);
    const remainingItems = quantity % promotion.minProducts;
    const discountedPrice = product.price - promotion?.discountValue;
    const promotionTotal =
      promotionSets * promotion.minProducts * discountedPrice;
