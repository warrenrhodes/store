...
const CartSideBar: React.FC<CartSideBarProps> = () => {
  ...
  const calculateTotalPrice = (
    ...
    const promotionSets = Math.floor(quantity / promotion.minProductsToApply);
    const remainingItems = quantity % promotion.minProductsToApply;
    const discountedPrice = product.price - promotion?.discountValue;
    const promotionTotal =
      promotionSets * promotion.minProductsToApply * discountedPrice;
    const remainingTotal = remainingItems * product.price;
