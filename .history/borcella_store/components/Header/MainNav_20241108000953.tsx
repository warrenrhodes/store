      ...
      <div className="flex flex-1 items-center justify-end gap-5">
        <div className="flex items-center divide-x divide-neutral-300">
          ...
          <div className="flex items-center gap-2 pl-5">
            <Button className="w-70 h-70 overflow-hidden bg-gray ttnc-ButtonCircle flex items-center justify-center rounded-full !leading-none focus:ring-transparent disabled:bg-opacity-70">
              <Image
                src={"/avatar.png"}
                alt="avatar"
                fill
