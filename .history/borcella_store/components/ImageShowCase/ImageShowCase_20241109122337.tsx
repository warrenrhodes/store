...
const ImageShowCase: FC<ImageShowCaseProps> = ({ medias }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-full gap-4 min-h-[300px] sm:min-h-[400px] bg-black p-4">
      <div className="flex sm:flex-col order-2 sm:order-1 w-full sm:w-24 gap-2 overflow-x-auto sm:overflow-y-auto">
      ...
      <div className="relative order-1 sm:order-2 w-full h-[300px] sm:h-[400px] rounded-lg overflow-hidden">
        <Image
