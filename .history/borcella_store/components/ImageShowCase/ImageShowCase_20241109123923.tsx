...
const ImageShowCase: FC<ImageShowCaseProps> = ({ medias }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-full gap-1 min-h-[400px] sm:min-h-[400px]">
      ...
      <div className="relative order-2 w-full h-[300px] sm:h-[400px] rounded-lg overflow-hidden ring-2 ring-white ring-offset-2 ring-offset-muted/50 bg-muted/20">
        <Image
