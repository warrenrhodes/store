...
const ProductGallery = () => {
  ...
  const images = [
    { id: 1, url: "/api/placeholder/600/800", alt: "Product view 1" },
    { id: 2, url: "/api/placeholder/600/800", alt: "Product view 2" },
    { id: 3, url: "/api/placeholder/600/800", alt: "Product view 3" },
    { id: 4, url: "/api/placeholder/600/800", alt: "Product view 4" },
  ];
