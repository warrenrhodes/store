import { benefices, promotions, reviews } from "@/utils/fake_data";
import { BeneficeType, ProductType, PromotionType, ReviewType } from "../types";
...
export const getPromotionByProductId = async (
  productId: string
): Promise<PromotionType[] | null> => {
  return promotions.filter((e) => e.productId === productId);
};
