...
export const benefices: BeneficeType[] = [
  {
    _id: Math.random().toString(106).substring(2, 8),
...
export const reviews: ReviewType[] = [
  {
    _id: Math.random().toString(15226).substring(2, 8),
    productId: "672b4f67297584e8eb4389ca",
    userName: "Alice",
    rating: 4.5,
  ...
  {
    _id: Math.random().toString(1006).substring(2, 8),
    productId: "672b4f67297584e8eb4389ca",
    userName: "Bob",
    rating: 3.0,
  ...
  {
    _id: Math.random().toString(1236).substring(2, 8),
    productId: "672b4f67297584e8eb4389ca",
    userName: "Charlie",
    rating: 5.0,
