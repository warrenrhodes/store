...
const Orders = async () => {
  ...
  return (
    <div className="px-10 py-5 max-sm:px-3">
      ...
      {!orders ||
        (orders.length === 0 && <p className="text-body-bold my-5">You have no orders yet.</p>)}
            ...
            <div className="flex flex-col gap-5">
              {order.products.map((orderItem: OrderItemType) => (
                <div className="flex gap-4">
                  <Image
                    src={orderItem.product.media[0].url}
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="text-small-medium">
                      Unit price:{' '}
                      <span className="text-small-bold">{orderItem.product.promoPrice}</span>
                    </p>
                    <p className="text-small-medium">
